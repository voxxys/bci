function create_expsetup_base_main_6_states(fpath_expsetup, fpath_chanlocs)
...
expsetup.sigsrc_stage_desc.params.params_spec.fpath_in = 'D:\BCI\EXP_DATA\EXP_LSL32_new\1305_lisa_re_first.mat';
...
expsetup.stategen_stage_desc.obj_type = 't_state_generator_4states_rand';
...
% expsetup.visualizers(n).type = 't_visualizer_state_2';
...
% expsetup.visualizers(n).params.sig_descs{2}.stage_name = 'LDA_2_6';
...
% % expsetup.visualizers(n).params.sig_descs{3}.stage_name = 'LDA_3_6';
...
% % expsetup.visualizers(n).params.sig_descs{4}.stage_name = 'LDA_4_6';
...
% expsetup.visualizers(n).params.sig_descs{3}.data_type = 'SIGNAL';
% expsetup.visualizers(n).params.sig_descs{3}.stage_name = 'LDA_5_6';
% expsetup.visualizers(n).params.sig_descs{3}.chan_names_data = {'pred_smooth'};
% expsetup.visualizers(n).params.sig_descs{3}.vis_win_t = 10;
% expsetup.visualizers(n).params.sig_descs{3}.smooth_len_t = 0;
% expsetup.visualizers(n).params.sig_descs{3}.need_square = 0;
% expsetup.visualizers(n).params.sig_descs{3}.k = [-1, 2];
% expsetup.visualizers(n).params.sig_descs{3}.spread_channels = 0;
% expsetup.visualizers(n).params.sig_descs{4}.data_type = 'STATE';
% expsetup.visualizers(n).params.sig_descs{4}.stage_name = '[INPUT]';
% expsetup.visualizers(n).params.sig_descs{4}.chan_names_data = {'STATE'};
% expsetup.visualizers(n).params.sig_descs{4}.vis_win_t = 10;
% expsetup.visualizers(n).params.sig_descs{4}.smooth_len_t = 0;
% expsetup.visualizers(n).params.sig_descs{4}.need_square = 0;
% expsetup.visualizers(n).params.sig_descs{4}.k = [-3, 2];
% expsetup.visualizers(n).params.sig_descs{4}.spread_channels = 0;
