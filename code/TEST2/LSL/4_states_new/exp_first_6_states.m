...
fname_expresult ='0805_xenia_im_first_4s';
...
create_paradigm_first_6_states(fpath_paradigm, fpath_chanlocs);


%=========================================
% Create base experimental setup

create_expsetup_base_first_6_states(fpath_expsetup_base, fpath_chanlocs);
