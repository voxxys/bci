...
fname_expresult ='0805_xenia_re_first_2s';
...
create_paradigm_first_2_states(fpath_paradigm, fpath_chanlocs);


%=========================================
% Create base experimental setup

create_expsetup_base_first_2_states(fpath_expsetup_base, fpath_chanlocs);
