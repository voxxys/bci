START_DIR = D:\bci\code\SANDBOX\codegen\mex\toCtest

MATLAB_ROOT = D:\R2014a
MAKEFILE = toCtest_mex.mk

include toCtest_mex.mki
...
MEX_FILE_NAME_WO_EXT = toCtest_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\toCtest"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\toCtest\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\toCtest/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
