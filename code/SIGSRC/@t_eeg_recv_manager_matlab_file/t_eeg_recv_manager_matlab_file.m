classdef t_eeg_recv_manager_matlab_file < t_eeg_recv_manager_base
% Reads EEG data from eeglab dataset
    ...
    methods (Access=public)
        ...
        %===================================
        % Constructor
        function this = t_eeg_recv_manager_matlab_file(name)
        ...
        function srate = get_srate(this)
            srate = this.EEG.data.srate;
        end       
        
        %===================================
        function chan_names = get_chan_names_out(this)
            chan_names = this.EEG.data.chan_names;
        end       
